...
void operator_max_pool(const Tensor* inputs, Tensor* mask, int kernel_h,
											 int kernel_w, int pad_h, int pad_w, int stride_h,
											 int stride_w, Tensor* output) {
...
void operator_d_max_pool(const Tensor* output_grads, const Tensor* inputs,
												 const Tensor* mask, int kernel_h, int kernel_w,
